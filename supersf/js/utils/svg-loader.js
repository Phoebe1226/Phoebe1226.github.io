const svgWrap = document.createElement('div'),
  ...
  <svg style="display: none;">
    <symbol id="svg-more-dots" viewBox="0 0 22 6" preserveAspectRatio="xMinYMin meet">
      <path d="M19,6c-1.7,0-3-1.3-3-3s1.3-3,3-3s3,1.3,3,3S20.7,6,19,6z M11,6C9.3,6,8,4.7,8,3s1.3-3,3-3s3,1.3,3,3S12.7,6,11,6z M3,6
	C1.3,6,0,4.7,0,3s1.3-3,3-3c1.7,0,3,1.3,3,3S4.7,6,3,6z"/>
    </symbol>
  </svg>
  <!-- /SVG MORE DOTS -->
